...
class Manage extends Component
{
    ...
    /**
     * Get filtered people based on search - Only entrepreneurs (case-insensitive)
     */
    public function getPeopleProperty()
    {
        $entrepreneurProfessions = config('professions.entrepreneur', []);
        ...
        return People::active()
            ...
            ->byProfessionCategory('entrepreneurs')
            ->orderBy('name')
            ->limit(50)
            ->get();
    }
