    ...
    <form wire:submit.prevent="performSearch" class="relative">
        <div class="relative">
            <input
                ...
                class="w-full bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 placeholder-gray-400 {{ $variant === 'hero' ? 'pl-5 pr-12 py-3 text-base rounded-xl' : ($variant === 'compact' ? 'pl-3 pr-10 py-2 text-sm' : 'pl-4 pr-11 py-2.5') }}"
            >
            ...
            <button
                type="submit"
                aria-label="Search"
                class="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-red-600 p-1 rounded-lg transition duration-150"
            >
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
