                ...
                class="block border-l-4 border-blue-500 pl-4 py-2 hover:bg-blue-50 rounded-r-lg transition-colors duration-200 group">
                    <div>
                        ...
                        <h4 class="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-200 mb-1">
                            {{ $career->position }}
                            <svg class="w-4 h-4 inline-block ml-1 text-gray-400 group-hover:text-blue-500 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
