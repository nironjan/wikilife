                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">Discover the latest news, insights, and stories about famous personalities and trending topics</p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="flex items-center justify-between mb-2">
                                            @if($article->blogCategory)
                                                <a
                                                    ...
                                                    class="inline-flex items-center px-4 py-2 text-blue-800 text-sm font-semibold hover:text-blue-900 transition-colors duration-200"
                                                >
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                    ...
                    <div class="space-y-3">
                        @foreach($categories as $cat)
                            ...
                            >
                                <span class="font-semibold text-gray-700 group-hover:text-blue-700 {{ $category === $cat->slug ? 'text-blue-700' : '' }}">
                                    {{ $cat->name }}
                                </span>
