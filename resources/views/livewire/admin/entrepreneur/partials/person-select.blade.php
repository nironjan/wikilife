<div>
    ...
    <div class="space-y-2">
        ...
        <!-- Results Dropdown -->
        <!-- In the results dropdown section of person-select.blade.php -->
        @if ($person_search && !$person_id)
            <div
                ...
                @forelse($this->people as $person)
                    <button type="button" wire:click="$set('person_id', '{{ $person->id }}')"
                        ...
                        <div class="flex-1">
                            ...
                            @endif
                            <!-- Show entrepreneur indicator -->
                            @if ($person->hasProfession('entrepreneur') || $person->hasProfession('founder'))
                                <div class="mt-1">
                                    <span
                ...
                @empty
                    <div class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400">
                        No entrepreneurs found matching "{{ $person_search }}"
                    </div>
                @endforelse
            </div>
        @endif
