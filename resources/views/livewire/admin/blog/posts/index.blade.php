                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.live="search" id="search"
                               ...
                               placeholder="Search blog posts..." type="search">
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer"
                                    wire:click="sortBy('blog_category_id')">
                                    <div class="flex items-center space-x-1">
                                        <span>Category</span>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                            <span @class([
                                                ...
                                                'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' => $post->is_published,
                                                'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300' => !$post->is_published,
                                            ])>
                                        ...
                                        <div class="flex justify-end items-center space-x-2">
                                            <button wire:click="togglePublish({{ $post->id }})"
                                                @class([
                                                    ...
                                                    'border-orange-300 text-orange-600 bg-orange-50 hover:bg-orange-100 hover:border-orange-400 focus:ring-orange-500 dark:bg-orange-900/20 dark:border-orange-700 dark:text-orange-400 dark:hover:bg-orange-800/30' => $post->is_published,

                                                    // When not published → show "Publish" button (green)
                                                    'border-green-300 text-green-600 bg-green-50 hover:bg-green-100 hover:border-green-400 focus:ring-green-500 dark:bg-green-900/20 dark:border-green-700 dark:text-green-400 dark:hover:bg-green-800/30' => !$post->is_published,
                                                ])>
                                                {{ $post->is_published ? 'Unpublish' : 'Publish' }}
                                            </button>

                                            <a href="{{ route('webmaster.blog.posts.edit', $post->id) }}"
                                            ...
                                            <button wire:click="deleteBlogPost({{ $post->id }})"
